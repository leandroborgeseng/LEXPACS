...
function studyListLabel(key: string): string {
  return i18n.t(`StudyList:${key}`);
}
...
export function createDefaultColumns(): ColumnDef<StudyRow, unknown>[] {
  return [
    {
      ...
      meta: {
        label: studyListLabel('PatientName'),
    ...
    },
    {
      ...
      meta: {
        label: studyListLabel('StudyDate'),
    ...
    },
    {
      ...
      meta: {
        label: studyListLabel('Modalities'),
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className={!description ? 'text-muted-foreground/40' : ''}>
            {description || studyListLabel('NoDescription')}
          </div>
        );
      },
      meta: {
        label: studyListLabel('Description'),
    ...
    },
    {
      ...
      meta: {
        label: studyListLabel('AccessionNumber'),
    ...
    },
    {
      ...
      meta: {
        label: studyListLabel('Instances'),
        headerContent: (
          <Icons.Series
...
/** @deprecated Prefer createDefaultColumns() for live language updates */
export const defaultColumns: ColumnDef<StudyRow, unknown>[] = createDefaultColumns();
